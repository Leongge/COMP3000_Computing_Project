...
def train_AI(
    ...
    model = SAC(
        ...
        learning_rate=1e-3,
        batch_size=256,
        tensorboard_log="./tensorboard/test1/"
    ...
    model_path = r"C:\Users\leongsheng\source\repos\vflproject\pythonAPI\vfl_marl_version1.0\check_point\marl_15000000_steps_3goals.zip"
...
if __name__ == "__main__":
    ...
    env_fn = marlenv_custom
    env_kwargs ={}
    # print(f"c1: {c1}, l1: {l1}, c2: {c2}, l2: {l2}, c3: {c3}, l3: {l3}")
    # Train a marl model
    #train_AI(env_fn, steps=15000000, seed=0, **env_kwargs)
