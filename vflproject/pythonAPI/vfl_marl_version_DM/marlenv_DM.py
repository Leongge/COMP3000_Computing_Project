...
class MARLEnv(AECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # ]
        self.initial_design_parameters = [
            {"Name": "c1", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0},
            {"Name": "l1", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0},
            {"Name": "c2", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0},
            {"Name": "l2", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0},
            {"Name": "c3", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0},
            {"Name": "l3", "Value": 40, "Unit": "", "Imaginary": False, "Min": 10.0, "Max": 100.0}
        ]
        ...
        self.param_agents = dict(
            zip(self.agents, [ParamAgent_DM(idx, self.design_parameters, self.goals, self.design_model) for idx in
    ...
    def observe(self, agent):
        ...
        # new_list = observation + [current_agent_cost]
        # return new_list
        # print(observation)
        return observation
