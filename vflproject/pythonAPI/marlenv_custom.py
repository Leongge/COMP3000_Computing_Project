...
class MARLEnv(AECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        p_min = 0
        p_max = 1
        each_agent_action_space = gym.spaces.Box(low=-p_min, high=p_max, shape=(n_action,), dtype=np.float32)  # your normal gym action space
        ...
        s_min = 0
        s_max = 1
        each_agent_observation_sapce = gym.spaces.Box(low=s_min, high=s_max, shape=(n_obs,), dtype=np.float32, )  # your normal gym observation space
    ...
    def step(self, action):
        ...
        self.make_observation(s_parameters, frequency_values)
