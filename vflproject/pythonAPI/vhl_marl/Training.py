...
def train_butterfly_supersuit(
    ...
    # model_path = r"check_point/marl_120_steps.zip"
    # model = SAC.load(path=model_path, env=env)

    model.learn(total_timesteps=steps, log_interval=4, callback=callback_list, tb_log_name="50000_run")
...
if __name__ == "__main__":
    ...
    # Train a marl model
    train_butterfly_supersuit(env_fn, steps=100_000, seed=0, **env_kwargs)